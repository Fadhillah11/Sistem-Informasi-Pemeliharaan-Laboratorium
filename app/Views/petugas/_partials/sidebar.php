<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #0D6EFD;">
    ...
    <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="info">
                <a href="" class="d-block" style="color: white; font-size: 18px;">PETUGAS PEMELIHARAAN</a>
            </div>
        </div>
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="<?php echo base_url('home/index_petugas'); ?>" class="nav-link">
                        <i class="nav-icon fas fa-th"></i>
                        <p>Dashboard</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo base_url('komputer/index_petugas'); ?>" class="nav-link">
                        <i class="nav-icon fas fa fa-desktop"></i>
                        <p>Komputer</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo base_url('pemeliharaan'); ?>" class="nav-link">
